...
🌷 KALAU MAU RENAME TARO CREDITS GUA : 𝑅𝑎𝑛𝑧𝑧 䄀 */
...
let buttons = [
{buttonId: `𝑅𝑎𝑛𝑧𝑧`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
let buttons = [
{buttonId: `𝑅𝑎𝑛𝑧𝑧 䄀`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
